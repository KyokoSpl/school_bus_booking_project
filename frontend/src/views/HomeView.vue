  ...
  <div>
        ...
        <div class="max-w-3xl">
          ...
          <div class="bg-white rounded-xl p-6 shadow-2xl">
            <form @submit.prevent="handleSearch" class="flex flex-col md:flex-row gap-4">
              <div class="flex-1">
                <label class="block text-sm font-medium text-gray-700 mb-1">Wohin möchten Sie?</label>
                <input
              ...
              <div class="md:w-48">
                <label class="block text-sm font-medium text-gray-700 mb-1">Wann?</label>
                <input
      ...
      <div class="container mx-auto px-4">
        <div class="grid md:grid-cols-3 gap-8">
          <div class="text-center p-6">
            ...
            <h3 class="text-xl font-semibold mb-2">Sichere Buchung</h3>
            <p class="text-gray-600">Verschlüsselte Datenübertragung und sichere Zahlungsabwicklung für Ihre Sicherheit.</p>
          </div>
          <div class="text-center p-6">
            <div class="w-16 h-16 mx-auto mb-4 bg-primary-100 rounded-full flex items-center justify-center">
              <svg class="w-8 h-8 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <h3 class="text-xl font-semibold mb-2">Flexible Buchung</h3>
            <p class="text-gray-600">Einfache Online-Buchung rund um die Uhr mit sofortiger Bestätigung per E-Mail.</p>
          </div>
          <div class="text-center p-6">
            <div class="w-16 h-16 mx-auto mb-4 bg-primary-100 rounded-full flex items-center justify-center">
              <svg class="w-8 h-8 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <h3 class="text-xl font-semibold mb-2">Persönlicher Service</h3>
            <p class="text-gray-600">Unser freundliches Team steht Ihnen bei Fragen gerne zur Verfügung.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="py-16">
      <div class="container mx-auto px-4">
        <div class="text-center mb-12">
          <h2 class="text-3xl md:text-4xl font-bold mb-4">Beliebte Reisen</h2>
        ...
        <div v-else-if="featuredTrips.length === 0" class="text-center text-gray-500">
          ...
          >
            ...
            <div class="p-6">
              <div class="flex items-center justify-between mb-2">
                ...
                <span class="text-2xl font-bold text-primary-600">{{ formatPrice(trip.preis_pro_person) }}</span>
              </div>
              <h3 class="text-xl font-semibold mb-2">{{ trip.titel }}</h3>
              <p class="text-gray-600 mb-4 line-clamp-2">{{ trip.beschreibung }}</p>
    ...
    <section class="py-16 bg-primary-600 text-white">
      <div class="container mx-auto px-4 text-center">
        ...
        <router-link :to="{ name: 'register' }" class="btn bg-white text-primary-600 hover:bg-gray-100 text-lg px-8 py-3">
          Jetzt registrieren
        </router-link>
      </div>
    </section>
