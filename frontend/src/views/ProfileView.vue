      ...
      <div class="card p-6">
        <form @submit.prevent="handleSaveProfile" class="space-y-6">
          ...
          <div>
            ...
            />
            <p class="text-sm text-gray-500 mt-1">E-Mail-Adresse kann nicht geändert werden</p>
          </div>
    ...
    <div v-if="activeTab === 'password'" class="max-w-md">
      <div class="card p-6">
        <form @submit.prevent="handleChangePassword" class="space-y-6">
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Neues Passwort * (min. 8 Zeichen)</label>
            <input
          ...
          <div>
            ...
            <input
              ...
              required
              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500"
              :class="{ 'border-red-500': passwordForm.confirm_password && passwordForm.new_password !== passwordForm.confirm_password }"
            />
            <p v-if="passwordForm.confirm_password && passwordForm.new_password !== passwordForm.confirm_password" class="text-red-500 text-sm mt-1">
